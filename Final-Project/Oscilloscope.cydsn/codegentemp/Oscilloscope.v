// ======================================================================
// Oscilloscope.v generated from TopDesign.cysch
// 06/06/2018 at 22:21
...
module USBFS_v3_20_0 (
	...
	cy_psoc3_pins_v1_10
		#(.id("419a98b6-1779-42df-ac21-a9f99d5413e6/8b77a6c4-10a0-4390-971c-672353e2a49c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("419a98b6-1779-42df-ac21-a9f99d5413e6/618a72fc-5ddd-4df5-958f-a3d55102db42"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	assign dma_complete[3] = Net_1567;
...
module ADC_SAR_v3_10_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("4906ecf0-9e4c-4965-b344-2c714b16fbe2/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// ADC_SAR_v3_10(ADC_Clock=1, ADC_Clock_Frequency=1400000, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=1, ADC_Resolution=8, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=6, Sample_Rate=100000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_10, CY_CONFIG_TITLE=ADC_CH2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_CH2, CY_INSTANCE_SHORT_NAME=ADC_CH2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=ADC_CH2, )
module ADC_SAR_v3_10_4 (
	...
	cy_psoc3_pins_v1_10
		#(.id("ed36a278-cf6e-4424-bdff-e5af0e0fa1a3/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__Ch1In_net;
	wire [0:0] tmpFB_0__Ch1In_net;
	wire [0:0] tmpIO_0__Ch1In_net;
	wire [0:0] tmpINTERRUPT_0__Ch1In_net;
	electrical [0:0] tmpSIOVREF__Ch1In_net;
	...
	cy_psoc3_pins_v1_10
		...
		Ch1In
		 (.oe(tmpOE__Ch1In_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Ch1In_net[0:0]}),
		  .analog({Net_3}),
		  .io({tmpIO_0__Ch1In_net[0:0]}),
		  .siovref(tmpSIOVREF__Ch1In_net),
		  .interrupt({tmpINTERRUPT_0__Ch1In_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Ch1In_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Ch2In_net;
	wire [0:0] tmpFB_0__Ch2In_net;
	wire [0:0] tmpIO_0__Ch2In_net;
	wire [0:0] tmpINTERRUPT_0__Ch2In_net;
	electrical [0:0] tmpSIOVREF__Ch2In_net;

	cy_psoc3_pins_v1_10
		#(.id("65d9a49d-1b19-4fdc-8b95-8a59ba07bfd6"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Ch2In
		 (.oe(tmpOE__Ch2In_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Ch2In_net[0:0]}),
		  .analog({Net_10}),
		  .io({tmpIO_0__Ch2In_net[0:0]}),
		  .siovref(tmpSIOVREF__Ch2In_net),
		  .interrupt({tmpINTERRUPT_0__Ch2In_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Ch2In_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("af79bfa6-195d-46ae-befa-631a412499d7"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("45673c69-2ff7-479a-8dfc-acab34f2718f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
