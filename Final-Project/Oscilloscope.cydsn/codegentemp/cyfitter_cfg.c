...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000230u)
...
#define BS_PHUB_CFGMEM4_VAL ((const uint8 CYFAR *)0x48000268u)

/* PHUB_CFGMEM5 Address: CYREG_PHUB_CFGMEM5_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM5_VAL ((const uint8 CYFAR *)0x4800026Cu)
